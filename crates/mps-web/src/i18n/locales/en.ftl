...
char-col-03-desc = solve_impulses forwards the captured contacts to solve_character_collision_impulses, applying the character's momentum to the dynamic bodies it is touching.
