        ...
        || match mps_formula::molecular::lennard_jones_potential(distance, epsilon, sigma) {
            ...
            None => {
                set_error(
                    ...
                    "invalid Lennard-Jones potential parameters",
                );
                f64::NAN
            }
        },
...
pub extern "C" fn molecular_coulomb_potential(
    ...
    ffi_guard(0.0, || {
        match mps_formula::molecular::coulomb_potential(
            distance,
            charge_a,
            charge_b,
            coulomb_constant,
            ...
            None => {
                set_error(ERR_INVALID_ARGUMENT, "invalid Coulomb potential parameters");
                f64::NAN
            }
        }
    })
...
pub extern "C" fn molecular_coulomb_force(
    ...
    ffi_guard(Bool::FALSE, || {
        ...
        match mps_formula::molecular::coulomb_force(
            displacement,
            charge_a,
            charge_b,
            coulomb_constant,
...
pub extern "C" fn molecular_apply_pair_forces(
    ...
    ffi_guard(Bool::FALSE, || {
        ...
        let Some(report) =
            mps_formula::molecular::compute_pair_interaction(particle_a, particle_b, law)
        else {
            set_error(
                ERR_INVALID_ARGUMENT,
