...
use crate::rapier::ffi::{
    ...
    pack_rigid_body_handle, shape_from_desc, vec3_to_rapier,
};
...
pub extern "C" fn fracture_mesh_body_create(
    ...
    ffi_guard(u32::MAX, || {
        ...
        if fragment_count == 0 || fragment_count > MAX_FRACTURE_MESH_PARTS {
        ...
        world.inner.fracture_mesh_bodies.insert(
            ...
            FractureMeshBody {
                ...
                fragments: fragments_slice.to_vec(),
                connect_fragments: connect_fragments.0 != 0,
                fatigue_damage: 0.0,
