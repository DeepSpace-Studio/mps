...
pub extern "C" fn aero_apply_surfaces(
    ...
    ffi_guard(Bool::FALSE, || {
        ...
        if !vec3_finite(wind_velocity) || !air_density.is_finite() || air_density < 0.0 {
            set_error(ERR_INVALID_ARGUMENT, "invalid wind velocity or air density");
            return Bool::FALSE;
        }
        ...
        for surface in surfaces {
            ...
            body.add_force_at_point(
                vec3_to_rapier(force),
                vec3_to_rapier(surface.point),
                wake_up.0 != 0,
            );
    ...
    ffi_guard(Bool::FALSE, || {
            ...
            || air_density < 0.0
        {
            set_error(
                ...
                "invalid aerodynamic surface parameters",
            );
            return Bool::FALSE;
        }
