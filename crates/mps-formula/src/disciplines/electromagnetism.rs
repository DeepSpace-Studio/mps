...
mod __formulas_reexports {
    ...
    pub use crate::scientists::james_clerk_maxwell::formulas::ampere_maxwell_displacement_term;
    ...
    pub use crate::scientists::james_clerk_maxwell::formulas::displacement_current_density;
    pub use crate::scientists::james_clerk_maxwell::formulas::effective_aperture;
    pub use crate::scientists::james_clerk_maxwell::formulas::em_wave_energy_density;
    ...
    pub use crate::scientists::james_clerk_maxwell::formulas::gauss_law_electric_flux;
    ...
    pub use crate::scientists::james_clerk_maxwell::formulas::maxwell_speed_of_light;
