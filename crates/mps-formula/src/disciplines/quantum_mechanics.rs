...
mod __formulas_reexports {
    ...
    pub use crate::scientists::erwin_schrodinger::formulas::de_broglie_wavelength;
    ...
    pub use crate::scientists::paul_dirac::formulas::de_broglie_wavelength as de_broglie_wavelength_paul_dirac;
